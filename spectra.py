...
class Spectrum:
    def __init__(self, file_path=None, x=None, y=None, t=None, tstamp=None,
                 index=0, data_type='PVMS'):
...
class Spectra:
    def __init__(self, file_path=None, spectrums=None, data=None, tstamp=None, data_type='PVMS'):
    ...
    def __getitem__(self, key):
        ...
        raise KeyError('Spectra has no attribute ' + key + 
                       ', and spectra.data has no key ' + key)
...
def data_to_spectrums(data):
    ...
    for (n, t) in enumerate(ts):
        try:
            ...
            print('Warning!!! couldn\'t convert value ' + 
                  ' in spectrum number ' + str(n) + '. Skipping that spectrum.')
            continue
